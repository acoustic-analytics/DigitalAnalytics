Pod::Spec.new do |s|
  ...
  s.library = 'z'
  s.resource = "SDKs/iOS/Debug/DAMod.xcframework/*/DAMod.framework/DAMod.bundle"
  s.xcconfig = { 'HEADER_SEARCH_PATHS' => '"$(PODS_ROOT)/SDKs/iOS/Debug/DAMod.xcframework/*/DAMod.framework/Headers/"/** ' }
  s.source = { :git => 'https://github.com/acoustic-analytics/DigitalAnalytics.git', :tag => '1.1.44'}
