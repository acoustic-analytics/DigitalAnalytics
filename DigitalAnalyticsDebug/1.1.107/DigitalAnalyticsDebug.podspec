...
Pod::Spec.new do |s|
  ...
  s.license = { :type => 'Proprietary, Acoustic, L.P.', :text => 'https://github.com/go-acoustic/DigitalAnalytics/blob/master/Licenses/License' }
  s.homepage = 'https://github.com/go-acoustic/DigitalAnalytics'
  ...
  s.source = { :git => 'https://github.com/go-acoustic/DigitalAnalytics.git', :tag => '1.1.107'}
